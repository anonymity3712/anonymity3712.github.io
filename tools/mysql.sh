...
md5check="f28e51910f02645ea890a2c30becbb29"
...
mysql_mariadb_101='10.1.43'
mysql_mariadb_102='10.2.29'
mysql_mariadb_103='10.3.20'
mysql_mariadb_104='10.4.10'
...
Install_Configure(){
	...
	if [ $? -ne 0 ];then
		echo '========================================================'
		GetSysInfo
		echo -e "ERROR: mysql installation failed.";
